    ...
    <div class="container mx-auto  bg-white shadow-md rounded-md p-8">
        ...
        <div class="flex justify-between items-center">
            ...
            @if (auth()->user()->role === 'Doctor')
                <a wire:navigate href="{{ route('record.manage') }}"
                    class="bg-blue-500 text-white text-sm font-bold py-2 px-4 rounded transition hover:bg-blue-600">{{ __('Manage Records') }}</a>
            @endif
        </div>
        <hr class="py-4">
        ...
        <section class="mb-8">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="form-group">
                    <label class="block text-sm font-medium text-gray-700">Dermatological Lesion and Type</label>
