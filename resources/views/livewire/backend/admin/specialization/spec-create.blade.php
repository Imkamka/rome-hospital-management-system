<div>
    <div class="container  bg-white p-6 rounded-lg">
        <div class="flex justify-between items-center  mb-4">
            <h2 class="text-2xl font-semibold">{{ __('Create Specialization') }}</h2>
        ...
        <form wire:submit.prevent="create">
            ...
            <div class="flex justify-end">
                <button
                    class="bg-blue-500 text-white text-sm font-bold py-2 px-4 rounded transition hover:bg-blue-600">Save</button>
            </div>
        </form>
    </div>
</div>
